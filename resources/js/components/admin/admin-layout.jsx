          ...
          <div className='flex items-center justify-between'>
            ...
            <div className='flex items-center'>
              ...
              <div className='flex items-center ml-3'>
                <div>
                  <button type='button' className='flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300' id='user-menu-button'>
      ...
      <aside className={`fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} bg-white border-r border-gray-200 md:translate-x-0`}>
        <div className='h-full px-3 pb-4 overflow-y-auto bg-white'>
          <ul className='space-y-2 font-medium'>
            <li>
              <Link to={route('dashboard')} className={`flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group ${pathname === '/admin' ? 'bg-gray-100' : ''}`}>
            ...
            <li>
              <Link to={route('books.index')} className={`flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group ${pathname === '/admin/books' ? 'bg-gray-100' : ''}`}>
            ...
            <li>
              <Link to={route('categories.index')} className={`flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group ${pathname === '/admin/categories' ? 'bg-gray-100' : ''}`}>
            ...
            <li>
              <Link to={route('reviews.index')} className={`flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group ${pathname === '/admin/reviews' ? 'bg-gray-100' : ''}`}>
            ...
            <li>
              <Link to={route('users.index')} className={`flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group ${pathname === '/admin/users' ? 'bg-gray-100' : ''}`}>
                <svg className='flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900' aria-hidden='true' xmlns='http://www.w3.org/2000/svg' fill='currentColor' viewBox='0 0 20 18'>
            ...
            <li>
              <Link to={route('orders.index')} className={`flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group ${pathname === '/admin/orders' ? 'bg-gray-100' : ''}`}>
                <svg className='flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900' aria-hidden='true' xmlns='http://www.w3.org/2000/svg' fill='currentColor' viewBox='0 0 18 20'>
                  <path d='M17 5.923A1 1 0 0 0 16 5h-3V4a4 4 0 1 0-8 0v1H2a1 1 0 0 0-1 .923L.086 17.846A2 2 0 0 0 2.08 20h13.84a2 2 0 0 0 1.994-2.153L17 5.923ZM7 9a1 1 0 0 1-2 0V7h2v2Zm0-5a2 2 0 1 1 4 0v1H7V4Zm6 5a1 1 0 1 1-2 0V7h2v2Z' />
                </svg>
            ...
            <li>
              <Link to={route('order-details.index')} className={`flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group ${pathname === '/admin/order-details' ? 'bg-gray-100' : ''}`}>
                <svg className='flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900' aria-hidden='true' xmlns='http://www.w3.org/2000/svg' fill='currentColor' viewBox='0 0 20 20'>
