              ...
              <div className='flex items-center ml-3 relative' ref={dropdownRef}>
                ...
                {open && (
                  <div className='absolute right-0 top-full mt-2 w-48 z-50 bg-gray-50 border border-black divide-y divide-gray-100 rounded-lg shadow-sm'>
                    ...
                    <ul className='py-1'>
                      <li>
                        <Link to='/admin' className='block px-4 py-2 text-sm text-gray-700 hover:bg-gray-200'>
                          Dashboard
                        </Link>
                      </li>
                      <li>
          ...
          <ul className='space-y-2 font-medium'>
            ...
            <li>
              <Link href='/admin/order-details' className={`flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group ${url === '/admin/order-details' ? 'bg-gray-100' : ''}`}>
                <svg className={`w-5 h-5  transition duration-75  ${url === '/admin/order-details' ? 'group:text-gray-900' : 'text-gray-500 group-hover:text-gray-900'}`} aria-hidden='true' xmlns='http://www.w3.org/2000/svg' fill='currentColor' viewBox='0 0 20 20'>
