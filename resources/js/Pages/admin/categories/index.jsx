...
export default function CategoriesIndex() {
  return (
      ...
      <div id='drawer-update-product-default' className='fixed top-0 right-0 z-40 w-full h-screen max-w-xs p-4 overflow-y-auto transition-transform translate-x-full bg-white ' tabindex='-1' aria-labelledby='drawer-label' aria-hidden='true'>
        <h5 id='drawer-label' className='inline-flex items-center mb-6 text-sm font-semibold text-gray-500 uppercase '>
          Update Product
        </h5>
        <button type='button' data-drawer-dismiss='drawer-update-product-default' aria-controls='drawer-update-product-default' className='text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 absolute top-2.5 right-2.5 inline-flex items-center  '>
        ...
        <form action='#'>
          <div className='space-y-4'>
            <div>
              ...
              <input type='text' name='title' id='name' className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5      ' value='Education Dashboard' placeholder='Type product name' required='' />
            </div>
            <div>
            ...
            <div>
              ...
              <input type='number' name='price' id='price' className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5      ' value='2999' placeholder='$149' required='' />
            </div>
            <div>
              <label for='description' className='block mb-2 text-sm font-medium text-gray-900 '>
                Description
              </label>
              <textarea id='description' rows='4' className='block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500      ' placeholder='Enter event description here'>
                Start developing with an open-source library of over 450+ UI components, sections, and pages built with the utility classNamees from Tailwind CSS and designed in Figma.
              </textarea>
            </div>
            <div>
              <label for='discount' className='block mb-2 text-sm font-medium text-gray-900 '>
                Discount
              </label>
          ...
          <div className='bottom-0 left-0 flex justify-center w-full pb-4 mt-4 space-x-4 sm:absolute sm:px-4 sm:mt-0'>
            ...
            <button type='button' className='w-full justify-center text-red-600 inline-flex items-center hover:text-white border border-red-600 hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center     '>
      ...
      <div id='drawer-delete-product-default' className='fixed top-0 right-0 z-40 w-full h-screen max-w-xs p-4 overflow-y-auto transition-transform translate-x-full bg-white ' tabindex='-1' aria-labelledby='drawer-label' aria-hidden='true'>
        <h5 id='drawer-label' className='inline-flex items-center text-sm font-semibold text-gray-500 uppercase '>
          Delete item
        </h5>
        <button type='button' data-drawer-dismiss='drawer-delete-product-default' aria-controls='drawer-delete-product-default' className='text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 absolute top-2.5 right-2.5 inline-flex items-center  '>
          <svg aria-hidden='true' className='w-5 h-5' fill='currentColor' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'>
            <path fill-rule='evenodd' d='M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z' clip-rule='evenodd'></path>
          </svg>
          <span className='sr-only'>Close menu</span>
        ...
        <a href='#' className='text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2.5 text-center mr-2 '>
          Yes, I'm sure
        </a>
        <a href='#' className='text-gray-900 bg-white hover:bg-gray-100 focus:ring-4 focus:ring-primary-300 border border-gray-200 font-medium inline-flex items-center rounded-lg text-sm px-3 py-2.5 text-center      ' data-drawer-hide='drawer-delete-product-default'>
          No, cancel
        </a>
      </div>

      <div id='drawer-create-product-default' className='fixed top-0 right-0 z-40 w-full h-screen max-w-xs p-4 overflow-y-auto transition-transform translate-x-full bg-white ' tabindex='-1' aria-labelledby='drawer-label' aria-hidden='true'>
        <h5 id='drawer-label' className='inline-flex items-center mb-6 text-sm font-semibold text-gray-500 uppercase '>
          New Product
        </h5>
        <button type='button' data-drawer-dismiss='drawer-create-product-default' aria-controls='drawer-create-product-default' className='text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 absolute top-2.5 right-2.5 inline-flex items-center  '>
          <svg aria-hidden='true' className='w-5 h-5' fill='currentColor' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'>
            <path fill-rule='evenodd' d='M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z' clip-rule='evenodd'></path>
          </svg>
          <span className='sr-only'>Close menu</span>
        ...
        <form action='#'>
          <div className='space-y-4'>
            <div>
              ...
              <input type='text' name='title' id='name' className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5      ' placeholder='Type product name' required='' />
            </div>
            ...
            <div>
              <label for='category-create' className='block mb-2 text-sm font-medium text-gray-900 '>
                Technology
              </label>
              <select id='category-create' className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5      '>
            ...
            <div>
              ...
              <textarea id='description' rows='4' className='block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500      ' placeholder='Enter event description here'></textarea>
            </div>
            <div>
              <label for='discount-create' className='block mb-2 text-sm font-medium text-gray-900 '>
                Discount
              </label>
