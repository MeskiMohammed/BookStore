...
function Home() {
  ...
  return (
    <>
          ...
          <div>
            ...
            <div className='mt-6 lg:mt-10 grid grid-cols-2 gap-x-5'>
              ...
              <div className='py-5'>
                ...
                <div className='mt-5'>
                  {/* Star */}
                  <svg className='h-auto w-16 text-gray-800  ' width='110' height='28' viewBox='0 0 110 28' fill='none' xmlns='http://www.w3.org/2000/svg'>
                    <path
        ...
        <div className='relative p-6 md:p-16'>
          ...
          <div className='relative z-10 lg:grid lg:grid-cols-12 lg:gap-16 lg:items-center'>
            <div className='mb-10 lg:mb-0 lg:col-span-6 lg:col-start-8 lg:order-2'>
              <h2 className='text-2xl text-gray-800 font-bold sm:text-3xl  '>Fully customizable rules to match your unique needs</h2>
      ...
      <BookSlider title='Best Sellers' books={books.bestSellers} />
      <BookSlider title='Popular' books={books.popular} />
      ...
      <section className='bg-white px-4 py-8 antialiased  md:py-16'>
        <div className='mx-auto grid max-w-screen-xl rounded-lg bg-gray-50 p-4  md:p-8 lg:grid-cols-12 lg:gap-8 lg:p-16 xl:gap-16'>
          ...
          <div className='me-auto place-self-center lg:col-span-7'>
            ...
            <p className='mb-6 text-gray-500 '>Reserve your new Apple iMac 27” today and enjoy exclusive savings with qualified activation. Pre-order now to secure your discount.</p>
