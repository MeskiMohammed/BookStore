  ...
  return (
    ...
    <div class='mb-4 mx-auto py-40 items-end justify-center space-y-4 sm:flex sm:space-y-0 md:mb-8'>
      ...
      <div className="flex flex-col border border-gray-200 rounded-xl p-4 sm:p-6 lg:p-8 blue">
        <h2 className="mb-8 text-xl font-semibold text-gray-800 blue">
        ...
        <form>
          <div className="grid gap-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label htmlFor="hs-firstname-contacts-1" className="sr-only">Prenom</label>
            ...
            <div>
              <label htmlFor="hs-phone-number-1" className="sr-only">Telephome</label>
            ...
            <div>
              <label htmlFor="hs-about-contacts-1" className="sr-only">Détails</label>
