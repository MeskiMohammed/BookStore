          ...
          <div className='max-w-screen-xl px-4 mx-auto 2xl:px-0'>
            <div className='lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16'>
              ...
              <div className='mt-6 sm:mt-8 lg:mt-0'>
                <span className='bg-green-100 text-green-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded-md'>En stock</span>
                ...
                <div className='flex flex-col items-start mt-4  sm:gap-4 sm:flex'>
                  <p className='text-2xl font-extrabold text-gray-900 sm:text-3xl '>160 DH</p>
                ...
                <p className='mb-6 text-gray-500'>Quels que soient vos objectifs, Atomic Habits propose un cadre éprouvé pour progresser au quotidien. James Clear, l'un des plus grands experts mondiaux en formation d'habitudes, révèle des stratégies pratiques qui vous apprendront précisément à prendre de bonnes habitudes, à vous défaire des mauvaises et à maîtriser les petits gestes qui mènent à des résultats remarquables.</p>

                <p className='text-gray-500'>Apprenez à : prendre du temps pour de nouvelles habitudes, surmonter un manque de motivation et de volonté, concevoir votre environnement pour faciliter le succès et revenir sur la bonne voie lorsque vous vous égarez.</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className='mx-auto max-w-screen-xl px-4 2xl:px-0'>
            ...
            <div className='my-6 gap-8 sm:flex sm:items-start md:my-8'>
              <div className='shrink-0 space-y-4'>
                <p className='text-2xl font-semibold leading-none text-gray-900 '>4,65 sur 5</p>
              ...
              <div className='mt-6 min-w-0 flex-1 space-y-3 sm:mt-0'>
                <div className='flex items-center gap-2'>
                  ...
                  <Link href='#' className='w-8 shrink-0 text-right text-sm font-medium leading-none text-primary-700 hover:underline  sm:w-auto sm:text-left'>
                    239 <span className='hidden sm:inline'>avis</span>
                  </Link>
                </div>
                ...
                <div className='flex items-center gap-2'>
                  ...
                  <Link href='#' className='w-8 shrink-0 text-right text-sm font-medium leading-none text-primary-700 hover:underline  sm:w-auto sm:text-left'>
                    432 <span className='hidden sm:inline'>avis</span>
                  </Link>
                </div>
                ...
                <div className='flex items-center gap-2'>
                  ...
                  <Link href='#' className='w-8 shrink-0 text-right text-sm font-medium leading-none text-primary-700 hover:underline  sm:w-auto sm:text-left'>
                    53 <span className='hidden sm:inline'>avis</span>
                  </Link>
                </div>
                ...
                <div className='flex items-center gap-2'>
                  ...
                  <Link href='#' className='w-8 shrink-0 text-right text-sm font-medium leading-none text-primary-700 hover:underline  sm:w-auto sm:text-left'>
                    32 <span className='hidden sm:inline'>avis</span>
                  </Link>
                </div>
                ...
                <div className='flex items-center gap-2'>
                  ...
                  <Link href='#' className='w-8 shrink-0 text-right text-sm font-medium leading-none text-primary-700 hover:underline  sm:w-auto sm:text-left'>
                    13 <span className='hidden sm:inline'>avis</span>
                  </Link>
                </div>
              </div>
            </div>
            ...
            <div className='mt-6 divide-y divide-gray-200 '>
              <div className='gap-3 pb-6 sm:flex sm:items-start'>
                ...
                <div className='mt-4 min-w-0 flex-1 space-y-4 sm:mt-0'>
                  <p className='text-base font-normal text-gray-500 '>très bon livre je l'adore</p>
                </div>
              </div>
            </div>
          ...
          <div className='relative max-h-full w-full max-w-2xl p-4'>
            ...
            <div className='relative rounded-lg bg-white shadow '>
              ...
              <div className='flex items-center justify-between rounded-t border-b border-gray-200 p-4  md:p-5'>
                <div>
                  <h3 className='mb-1 text-lg font-semibold text-gray-900 '>Ajouter un avis pour :</h3>
                ...
                <button type='button' className='absolute right-5 top-5 ms-auto inline-flex h-8 w-8 items-center justify-center rounded-lg bg-transparent text-sm text-gray-400 hover:bg-gray-200 hover:text-gray-900  ' data-modal-toggle='review-modal'>
                  ...
                  <span className='sr-only'>Fermer la fenêtre modale</span>
                </button>
              </div>
              {/* <!-- Modal body --> */}
                ...
                <div className='mb-4 grid grid-cols-2 gap-4'>
                  <div className='col-span-2'>
                    <div className='flex items-center'>
                      ...
                      <span className='ms-2 text-lg font-bold text-gray-900 '>3.0 sur 5</span>
                    </div>
                  </div>
                  <div className='col-span-2'>
