      ...
      <main className='max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto'>
          ...
          <div className='max-w-2xl w-3/4 m-auto lg:w-1/2 mb-6 sm:mb-10 md:mb-16 text-center '>
            <h2 className='text-2xl sm:text-3xl lg:text-4xl text-black font-semibold'>Nos résultats en chiffres</h2>
          </div>
          {/* End Title */}
          {/* Grid */}
          <div className='grid items-center lg:grid-cols-12 gap-6 lg:gap-12'>
            <div className='lg:col-span-4'>
              ...
              <div className='lg:pe-6 xl:pe-12'>
                ...
                <p className='mt-2 sm:mt-3 text-gray-500 blue'>of our customers love our fast book deliveries and collection.</p>
              </div>
              {/* End Stats */}
            </div>
            {/* End Col */}
        ...
        <div className='py-10'>
          {/* Titre */}
          <div className='max-w-2xl w-3/4 m-auto lg:w-1/2 mb-6 sm:mb-10 md:mb-16 text-center'>
            <h2 className='text-2xl sm:text-3xl lg:text-4xl text-black font-semibold'>Apprécié par les amateurs de lecture à travers le monde</h2>
          </div>
          {/* Fin Titre */}
          ...
          <div className='grid sm:grid-cols-2 lg:grid-cols-3 gap-6'>
            ...
            <div className='flex h-auto'>
              <div className='flex flex-col bg-white rounded-xl'>
                <div className='flex-auto p-4 md:p-6'>
                  <p className='text-base italic md:text-lg text-gray-800'>" J'adore cette librairie en ligne ! J'ai trouvé des éditions rares que je cherchais depuis des années. Livraison rapide et service client au top ! "</p>
                </div>
                <div className='p-4 bg-gray-100 rounded-b-xl md:px-7'>
                  <div className='flex items-center gap-x-3'>
                    ...
                    <div className='grow'>
                      <p className='text-sm sm:text-base font-semibold text-gray-800'>Sophie Martin</p>
                      <p className='text-xs text-gray-500'>Passionnée de littérature</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className='flex h-auto'>
              <div className='flex flex-col bg-white rounded-xl'>
                <div className='flex-auto p-4 md:p-6'>
                  <p className='text-base italic md:text-lg text-gray-800'>" Une superbe collection de livres et des recommandations qui m'ont permis de découvrir de nouveaux auteurs. Une expérience incroyable pour les amoureux des livres ! "</p>
                </div>
                <div className='p-4 bg-gray-100 rounded-b-xl md:px-7'>
                  <div className='flex items-center gap-x-3'>
                    <div className='shrink-0'>
                    ...
                    <div className='grow'>
                      <p className='text-sm sm:text-base font-semibold text-gray-800'>Pierre Dupont</p>
                      <p className='text-xs text-gray-500'>Écrivain et lecteur assidu</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className='flex h-auto'>
              <div className='flex flex-col bg-white rounded-xl'>
                <div className='flex-auto p-4 md:p-6'>
                  <p className='text-base italic md:text-lg text-gray-800'>" Une interface intuitive, des prix abordables et un catalogue impressionnant ! Je recommande vivement cette librairie en ligne. "</p>
                </div>
                <div className='p-4 bg-gray-100 rounded-b-xl md:px-7'>
                  <div className='flex items-center gap-x-3'>
                    <div className='shrink-0'>
                    ...
                    <div className='grow'>
                      <p className='text-sm sm:text-base font-semibold text-gray-800'>Clara Lemaitre</p>
                      <p className='text-xs text-gray-500'>Étudiante en littérature</p>
                    </div>
                  </div>
                </div>
              </div>
